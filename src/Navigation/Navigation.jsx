    ...
    return (
        <div id="navigation-wrapper">
                ...
                <div id='navigation'>
                    ...
                    {/* <a id="about" data-navigation onClick={() => navigate('/about')} >About</a> */}
                    <a id="support" data-navigation onClick={() => navigateTo('/privacy')}>Privacy</a>
                    <a id="github" data-navigation target="_blank" href="https://github.com/castrapp">GitHub</a>
                    <a id="download" data-navigation onClick={() => navigateTo('/download')}>Download</a>
                ...
                <div id="mobile-menu">
                    ...
                    <div onClick={() => {
                        document.querySelector('#html').removeAttribute("mobile-menu-opened")
                        window.open("https://github.com/castrapp")
                    }}>GitHub</div>
                    <div onClick={() => {
                        document.querySelector('#html').removeAttribute("mobile-menu-opened")
                        navigateTo('/download')}
